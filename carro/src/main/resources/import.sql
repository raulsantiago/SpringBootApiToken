...
insert into users(nomeuser,email,login,senha) values ('Ricardo Lecheta','rlecheta@gmail.com','rlecheta','$2a$10$HKveMsPlst41Ie2LQgpijO691lUtZ8cLfcliAO1DD9TtZxEpaEoJe');
insert into users(nomeuser,email,login,senha) values ('Admin','admin@gmail.com','admin','$2a$10$HKveMsPlst41Ie2LQgpijO691lUtZ8cLfcliAO1DD9TtZxEpaEoJe');
insert into users(nomeuser,email,login,senha) values ('User','user@gmail.com','user','$2a$10$HKveMsPlst41Ie2LQgpijO691lUtZ8cLfcliAO1DD9TtZxEpaEoJe');
insert into role(nome) values ('ROLE_USER');
insert into role(nome) values ('ROLE_ADMIN');
insert into users_roles(users_iduser,role_id) values(1, 1);
insert into users_roles(users_iduser,role_id) values(2, 2);
insert into users_roles(users_iduser,role_id) values(3, 1);